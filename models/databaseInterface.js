var databaseInterface = function() {
  ...
  self.init = function() {
    db.serialize(function() {
      if (!exists) {
        ...
        db.run("CREATE TABLE SCORES (_id INTEGER PRIMARY KEY, score TEXT, _player_id INTEGER, _problem_id INTEGER,"+
  ...
  self.getScore = function(player,problem) {
    ...
    db.serialize(function() {
      ...
      db.each(statement, [player,problem], function(err, row) {
        console.log('score: ' + row.score);
        console.log(err);

      }, function() {
          console.log('completed getScore query');
          //
